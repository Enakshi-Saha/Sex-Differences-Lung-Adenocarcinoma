...
pdf("figure/paper_LUAD_boxplot_alldrugs_lnIC50_noOutlier.pdf",h=5,w=3)
for(drug in alldrug){
  ...
  boxplot(tab2$LN_IC50 ~ tab2$sex_matchYorigin,ylab="ln(IC50)",main=Title2,
    col=c("red","blue"),xlab=NA,outline=F)
}
plot.new()
